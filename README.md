...
or optionally with `-m` flag turned on https://stackoverflow.com/questions/50821312/what-is-the-effect-of-using-python-m-pip-instead-of-just-pip
        ...
        python -m pip install numpy opencv-python scipy matplotlib PySimpleGUI Pillow requests
...
The parameters (flags) description and their respective default values are as follows:
	...
	'-p1', '--param1', type=int, default=25, help='First method-specific parameter
...
The parameters (flags) description and their respective default values are as follows:
	...
	'-p1', '--param1', type=int, default=25, help='First method-specific parameter. Default 30'
